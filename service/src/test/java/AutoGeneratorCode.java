...
public class AutoGeneratorCode {
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/restful?useSSL=true&useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8");
        ...
        pc.setParent("learn.cloud");//这语句和上面语句，自动生成在com.learn.mybatisplu.AutoGeneratorCode目录下
        pc.setEntity("entity");  //其实不用设置，这些有默认值，这只是示范设置而已
...
//        mpg.setTemplate(templateConfig);
        ...
        strategy.setInclude("user_");  // 生成哪个表
